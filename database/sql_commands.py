...
class Database:
    ...
    def sql_create_db(self):
        ...
        self.connection.execute(sql_queries.CREATE_FORM_LIKE_QUERY)
    ...
    async def sql_insert_users(self, telegram_id,
        ...
        #     None,
        #     lambda: self.cursor.execute(sql_queries.START_INSERT_USER_QUERY,
        #                                 (None, telegram_id,
    ...
    def sql_liked_form_command(self, owner_telegram_id, liker_telegram_id):
        ...
        return self.cursor.execute(
            sql_queries.SELECT_LIKED_FORM_QUERY,
    ...
    def select_existed_link(self, telegram_id):
        ...
        return self.cursor.execute(
            sql_queries.SELECT_EXISTED_LINK_QUERY,
            (telegram_id,)
        ).fetchall()
    ...
    def select_owner_link_command(self, link):
        ...
        return self.cursor.execute(
            sql_queries.SELECT_LINK_OWNER_QUERY,
            (link,)
        ).fetchall()
